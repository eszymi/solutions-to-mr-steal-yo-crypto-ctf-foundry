...
contract BancorBondingCurve is Power {
    ...
    function calculatePurchaseReturn(
        ...
        (uint256 result, uint8 precision) = power(baseN, _reserveBalance, _reserveRatio, MAX_RESERVE_RATIO);
        ...
        returns (uint256)
    {
        ...
        (uint256 result, uint8 precision) = power(_supply, baseD, MAX_RESERVE_RATIO, _reserveRatio);
