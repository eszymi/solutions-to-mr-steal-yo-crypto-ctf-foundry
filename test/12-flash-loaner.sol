...
import {FlashLoanerExploiter} from "src/exploiter_contracts/flashLoaner_exploiter.sol";
...
contract Testing is Test {
    ...
    function testChallengeExploit() public {
        ...
        FlashLoanerExploiter exploiter = new FlashLoanerExploiter(address(flashLoaner),address(usdc), address(uniPair));
